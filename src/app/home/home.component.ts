...
export class HomeComponent {
    aboutMeText: any = [
      ...
      {
        "title": "Future Plans",
        "subtext": "My goals as a soon to be Web Dev",
    ...
    projectList: any = [
      {
        "title": "NBStats",
        "subtext": "As an avid Basketball fan, I noticed there weren't alot of visually compelling Stats Sites. Well, Here you go.",
      ...
      },
      {
        ...
        "subtext": "Being a Big Fan of the recent Zelda games, I was able to use a Rest API to creat an ingame item Tracker.",
        "url": "https://xavierlora.github.io/ZeldaApiApp/",
        "id": "2"
      },
      {
        "title": "CLCF Baseball",
        "subtext": "I was fortunate enough to have the opportunity to work with CLCF Baseball and design their latest site!",
